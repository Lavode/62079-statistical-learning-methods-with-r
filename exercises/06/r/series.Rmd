...
for (i in 1:x) {
  ...
  # Remove PRP from training data, else predictions are a bit easy
  cars.train = cars.norm[train, -7]
  cars.train.labels = cars.norm[train, 7]

  cars.test = cars.norm[test, -7]
  cars.test.labels = cars.norm[test, 7]
...
If we compare the mean MSE of our three models, we see that this time a linear regression with multiple variables outperforms the k-NN. As such, combined with the advantage of a compact representation which it offers, it seems the best choice of the three.
